var routes = [
  ...
  {
    path: '/invoice/',
    url: './pages/app_pages/invoice.html',
  },
  
   {
    path: '/invoice.AddNewInvoice/',
    url: './pages/app_pages/invoice.AddNewInvoice.html',
  },
  
  
   {
    path: '/Items.AddNewItem/',
    url: './pages/app_pages/Items.AddNewItem.html',
  },
  
  
  {
    path: '/Account.AddNewAccount/',
    url: './pages/app_pages/Account.AddNewAccount.html',
  },
  
  
  {
    path: '/Settings.CustomiseInvoice/',
    url: './pages/app_pages/Settings.CustomiseInvoice.html',
  },
  
   {
    path: '/Settings.AboutUs/',
    url: './pages/app_pages/Settings.AboutUs.html',
  },
  
  
   {
    path: '/invoice.AddNewInvoice.AddItem/',
    url: './pages/app_pages/invoice.AddNewInvoice.AddItem.html',
  },
  
  
   {
    path: '/Quote.AddNewQuote/',
    url: './pages/app_pages/Quote.AddNewQuote.html',
  },
  
  
     {
    path: '/Quote.view/',
    url: './pages/app_pages/Quote.view.html',
  },
  ...
  {
    path: '/Account/',
    url: './pages/app_pages/Account.html',
  },
  {
    path: '/calendar/',
  ...
  {
    path: '/Client/',
    url: './pages/app_pages/Client.html',
  },
  {
    path: '/Items/',
    url: './pages/app_pages/Items.html',
  },
  {
    path: '/chips/',
  ...
  {
    path: '/Settings/',
    url: './pages/app_pages/Settings.html',
  },
  {
    path: '/fab-morph/',
  ...
  {
    path: '/Quote/',
    url: './pages/app_pages/Quote.html',
  },
  {
    path: '/icons/',
